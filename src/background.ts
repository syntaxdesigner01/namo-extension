...
//         openTab(`https://open.spotify.com/search/${text}`);
//         return;
//     }

//     if (text.includes("get") && text.includes("image")) {
//         speak("Here’s something gentle.");
//         openTab(`https://www.pexels.com/search/cat/`);
//         return;
//     }

//     speak("I’m sorry. I didn't get the command. try again by saying play me with the song name. or get image with the name for images");
// }

// chrome.runtime.onMessage.addListener((msg) => {
//     if (msg.type === "OPPA_POPUP_OPENED") {
//         if (!hasGreetedThisSession) {
//             speak("Hi welcome . my name is  Oppa!.");
